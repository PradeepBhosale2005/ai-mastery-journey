"""JSONL logging utilities for prompts, raw model outputs, and errors."""
...
class InteractionLogger:
    """Write all interaction events to a JSONL log file."""

    def __init__(self, log_path: str = "logs/adversarial_log.jsonl") -> None:
    ...
    def log_raw_output(self, turn: str, model_name: str, raw_output: str) -> None:
        """Log the raw output received from a model."""
        self.log_event(
            {
    ...
    def log_error(self, turn: str, model_name: str, error_message: str) -> None:
        """Log an error that happened during one turn."""
        self.log_event(
            {
                "event_type": "error",
                "turn": turn,
