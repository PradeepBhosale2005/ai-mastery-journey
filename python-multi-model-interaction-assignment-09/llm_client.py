"""OpenAI-compatible client for company-hosted LLM APIs."""
...
class LLMClient:
    ...
    def from_environment(cls, prefix: str, name: str) -> "LLMClient":
        ...
        timeout = parse_timeout(os.getenv(f"{prefix}_TIMEOUT"), default=180)
...
def parse_timeout(value: Optional[str], default: int = 180) -> int:
